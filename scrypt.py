...
def generate_summary(text):
    ...
    response = openai.ChatCompletion.create(
        ...
        messages=[
            {"role": "system", "content": "Вы публицист, экономист, который читает книгу и пишет блог в повествовательном стиле. Ваша задача - проанализировать и пересказать в доступной манере, предоставленный текст из книги. Начиная, придумайте фразу вроде 'Анализируя прочитанное, я заметил ...' или 'Читая книгу, обнаружил интересные мысли...' и во фразе упоминайте номер главы, которую прочли, ее название и упоминайте автора и название книги. Также сравните то, что читаете с экономическими реалиями и событиями из 2010-2020 годов. Уложитесь в 300 слов. Пишите на украинском языке."},
